...
interface LocationHistoryRepository {
    fun getLocationHistory(locationId: Int?, coordinates: Coordinates?): Flow<LocationWithHistory?>
    suspend fun refreshHistory(locationId: Int?, coordinates: Coordinates?): Resource<Unit>
}
